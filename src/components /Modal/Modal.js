    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{['Donald Trump', 'Venezuela', 'Sweden', 'Bitcoin', 'PlayStation 5', 'Smartphones'].map((term) => <Chip label={term} color="primary" className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
